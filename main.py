...
class UnitSpec:
    ...
    def __init__(self, name, team, unit_type, range_km, ph_func, pk_func, target_delay_func, fire_time_func, speed_road_kmh, speed_offroad_kmh):
        self.name = name
...
def generate_troop_list(troop_list, unit_name, num_units, positions: List[Tuple[float,float,float]], affiliation: str):
